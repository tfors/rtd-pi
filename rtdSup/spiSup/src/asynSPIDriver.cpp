...
static const char* driverName = "asynSPIDriver";

asynSPIDriver::asynSPIDriver(const char* portName, unsigned char spiBus,
...
asynStatus asynSPIDriver::spi_connect(asynUser* pasynUser)
{
...
asynStatus asynSPIDriver::spi_disconnect(asynUser* pasynUser)
{
